            ...
            <div className="container">
                <form onSubmit={this.handleFormSubmit} noValidate>
                    ...
                    <div>
                        ...
                        <select name="department" id="department" ref={this.departmentRef}>
                            <option value="Ilmu Komputer">Ilmu Komputer</option>
                            <option value="Ilmu Komputer">Sistem Informasi</option>
                            <option value="Ilmu Komputer">Teknik Informatika</option>
                            <option value="Ilmu Komputer">Teknik Komputer</option>
                        </select>
                    </div>
